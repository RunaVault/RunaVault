module "auth_token_rotate_function" {
  source = "../modules/lambda"

  function_name = "auth_token_rotate"
  description   = "Lambda function to rotate a machine token"

  source_path = "${path.module}/../../../backend/auth_token_rotate"
  ...
  tags = merge(
    local.common_tags,
    {
      Name = "RunaVault_Lambda_AuthTokenRotate"
    }
  )
}
