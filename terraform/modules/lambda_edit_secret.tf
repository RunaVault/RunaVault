module "edit_secret_function" {
  source = "../modules/lambda"

  function_name = "edit_secret"
  description   = "Lambda function to edit secrets"

  source_path = "${path.module}/../../../backend/edit_secret"
  ...
  tags = merge(
    local.common_tags,
    {
      Name = "RunaVault_Lambda_EditSecret"
    }
  )
}
