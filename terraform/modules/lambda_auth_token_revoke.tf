module "auth_token_revoke_function" {
  source = "../modules/lambda"

  function_name = "auth_token_revoke"
  description   = "Lambda function to revoke a machine token"

  source_path = "${path.module}/../../../backend/auth_token_revoke"
  ...
  tags = merge(
    local.common_tags,
    {
      Name = "RunaVault_Lambda_AuthTokenRevoke"
    }
  )
}
