module "auth_token_list_function" {
  source = "../modules/lambda"

  function_name = "auth_token_list"
  description   = "Lambda function to list the caller's machine tokens"

  source_path = "${path.module}/../../../backend/auth_token_list"
  ...
  tags = merge(
    local.common_tags,
    {
      Name = "RunaVault_Lambda_AuthTokenList"
    }
  )
}
